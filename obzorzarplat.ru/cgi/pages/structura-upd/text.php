...
$page_content.='
<img src="'.$src1.'" width="90%" alt="Структура выборки в зависимости от коэффициента текучести кадров компании" />';
$page_content.='
</td>
';
...
$page_content.='
<img src="'.$src2.'" width="90%" alt="Структура выборки в зависимости от коэффициента текучести кадров компании" />';
$page_content.='
</td>
</tr>
';
...
'<tr>
<td colspan="2">
<p class="img_title">3. Структура выборки в зависимости от сферы деятельности компании</p>
<table>';
...
$page_content.='
<img src="'.$src5.'" width="90%" alt="Структура выборки в зависимости от возраста компании" />';
$page_content.='
</td>
';
...
$page_content.='
<img src="'.$src6.'" width="90%" alt="Структура выборки в зависимости от размера штата компании" />';
$page_content.='
</td>
</tr>
';
...
$page_content.='
<img src="'.$src7.'" width="90%" alt="Структура выборки в зависимости от динамичности развития компании" />
</td>
<td></td>
</tr>
</table>
...
$page_content.='
    <h1>Структура выборки по Санкт-Петербургу</h1>
<p class="attention">Общее число участвующих компаний в Санкт-Петербурге: <b>'.$comp_summ.'</b>. Общее количество сотрудников в Санкт-Петербурге: <b>'.$people_summ.'</b></p></br>
<p>В процентах указана доля компаний от общего числа компаний.</p>
<table width="100%">
';
...
?>
Путь к странице: <b><?=$page_url;?></b><br><br>
Страница создана!