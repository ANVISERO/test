...
<!-- /Yandex.Metrika counter -->
    ...
    <p>Все права защищены и охраняются законом<br />
      &copy; ООО &laquo;Ант-Менеджмент&raquo; 1996-<?php echo date('Y') ?> | <a href="/privacy_policy/" class="lk1">Политика Конфиденциальности</a> | <a href="/terms_of_use/" class="lk1">Правила пользования</a> | <a href="/user_agreement/" class="lk1">Публичный договор оферта</a> | <a href="/warranty/" class="lk1">Порядок оплаты и гарантии безопасности</a></p>
</div>
