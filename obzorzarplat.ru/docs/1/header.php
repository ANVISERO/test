 <div id="site_map">
     ...
     <div>
        ...
        <h3>Петербургский Кадровый клуб "Кочубей"</h3>
        <ul>
            <li><a href="/hrclub/" class="lk3">О Клубе "Кочубей"</a></li>
            <li><a href="/hrclub/news/" class="lk3">Новости клуба</a></li>
        </ul>
...
<!--[if lte IE 6]><table><tr><td><![endif]-->
        ...
        <li class="level1-li"><a href="/hrclub/">Клуб &laquo;Кочубей&raquo;<!--[if gte IE 7]><!--></a><!--<![endif]-->
            <ul class="level2">
            <li><a href="/hrclub/">О Клубе "Кочубей"</a></li>
            <li><a href="/hrclub/news/">Новости клуба</a></li>
            </ul>
            <!--[if lte IE 6]><table><tr><td><![endif]-->
        </li>
