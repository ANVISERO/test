...
<link href="/_css/business/print_report.css" rel="stylesheet" type="text/css">
</head>
<body>
<?php
...
$order_html=$root.'/business/_report/user'.$user_id.'/report_'.$order_id.'.txt';

if(file_exists($root.'/business/_report/user'.$user_id.'/report_'.$order_id.'.xls')){
    $href_xls='<a href="/business/_report/user'.$user_id.'/report_'.$order_id.'.xls"><img src="/_img/business/page_white_excel.png" title="Отчет в формате Excel" border="0" alt="Отчет в формате Excel"></a>';
}else{
    $href_xls='';
}
echo('
...
<a href="/business/archive/"><img src="/_img/menu_icons/archive2.png" title="Архив" border="0" alt="Архив" /></a>
