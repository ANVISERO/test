...
<table width="250" border="0" cellspacing="0" cellpadding="2">
  ...
  <tr>
	...
	<input type="button" value="Log In" class="but" onClick="self.location.href='/eng/users/'">	
       <input type="button" value="Log Out" class="but" onClick="self.location.href='/eng/users/?page=logout'"></td>
  </tr>
</table>
</td>
  </tr>
