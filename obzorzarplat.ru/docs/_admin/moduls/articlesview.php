...
<div id="wordsleft">
<div class="articles">
<p><em>Другие статьи по теме:</em></p>
<?
$limit=2;
$query="select * from for_articles where status='1' and lang='0' and section_id='1' and id!='$id' order by date desc limit $limit";
...
?>
<p align="right"><a href="/stats/" class="link_4">Все статьи &raquo;</a></p>
</div>
</div>
