...
$col_elem=mysqli_num_rows(mysqli_query($link,"select * from for_articles where status='1' and lang='0' and section_id='1'"));
...
$filter="select * from for_articles where status='1' and lang='0' and section_id='1' order by date desc limit $start_lim,$col_topage";
$kov="'";
