...
$limit=1;
$query="select * from for_articles where status='1' and lang='1' order by id desc limit $limit";
...
&nbsp;<a style="font-size:12px; font-style:normal; font-weight:bold; text-decoration:none; color: #000" href="/eng/stats/view/?id='.$row["id"].'">'.$row["zag"].'</a>	
<br>
'.$anons.'</td></tr></table>
');
$schet++;
