...
$id=mysqli_result(mysqli_query($link,"select id from hrclub_meeting_registration where email='$mail' AND hrclub_meeting_id='$meeting_id' AND key='$key'"),0,0);
...
$msg1='
Вы зарегистрировались на заседание Петербургского профессионального кадрового клуба "Кочубей": '.$meeting_title.'<br>
...
<br> Для подтверждения регистрации Вам необходимо перейти по ссылке, указанной в электронном письме, отправленном на Ваш почтовый ящик. После этого с Вами свяжется администратор профессионального кадрового клуба &laquo;Кочубей&raquo; - Петрова Екатерина </p>
<hr>
');
