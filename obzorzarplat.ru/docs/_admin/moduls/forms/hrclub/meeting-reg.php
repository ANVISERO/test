...
Регистрация на заседание клуба Кочубей
<hr>
Имя: '.$name.'<br>
...
$msg1='
Вы зарегистрировались на заседание Петербургского профессионального кадрового клуба "Кочубей"<br>
Для подтверждения подписки перейдите, пожалуйста, <a href="http://obzorzarplat.ru/hrclub/estimated_meeting/confirmation/?ID='.$id.'&amp;key='.$key.'">по ссылке&raquo;</a><br>
...
$topic1="Подписка на новости Петербургского профессионального кадрового клуба Кочубей";
...
echo('
<center><p><b>Вам на почту было отправлено письмо с просьбой подтверждения регистрации на заседание Петербургского профессионального кадрового клуба &laquo;Кочубей&raquo;.  Для активации необходимо будет перейти по ссылке, указанной в письме.</b></p></center>
<p>Спасибо за проявленный интерес!</p>
<hr>
');
}else{
echo("<p>Вы уже зарегистрированы на заседание Петербургского профессионального кадрового клуба &laquo;Кочубей&raquo;</p>");
}
}else{?>
...
<?}?>
<input type="button" value="Вернуться назад" class="but" onClick="history.back(-1);">