...
<table width="100%" border="0" cellspacing="0" cellpadding="6"  style="border:1px solid #999">
  <tr>
    ...
    <td align="center"><font style="color:#cc0000"><b>ВАШ ЗАРАБОТОК</b></font></td>
    <td align="center"><font style="color:#cc0000"><b>ВЫБЕРИТЕ ДЛЯ СРАВНЕНИЯ</b></font></td>
    </tr>
  <tr>
    <td width="160" align="center">Прошло секунд:<br><input type="text" name="sec" value="0" class="pol_4"></td>
    <td align="center"><strong>Зарплата</strong><br>
      <input name="sal" type="text" class="text" value="20000" maxlength="12"> руб/мес</td>
...
<option value="2600000">Юрий (Гоша) Куценко, 2.6 млн.руб./мес.</option>
  ...
  <tr>
    <td colspan="3" align="center" class="bb"><center>
      <input type="button" class="but" value="Пуск!" onClick="usnotime();"> <input type="button" class="but" value="Стоп!" onClick="stop();">
    </center></td>
    </tr>
  <tr>
    <td width="160" align="center" class="b_r"><strong>Пиво</strong><br><img class="ram" src="/_img/bigmak_1.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>25р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_1" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="b_r"><strong>Гамбургер</strong><br><img class="ram" src="/_img/bigmak_2.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>50р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_2" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="b_r"><strong>iPod</strong><br><img class="ram" src="/_img/bigmak_3.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>3 500р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_3" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="b_r"><strong>Цифровой фотоаппарат</strong><br><img class="ram" src="/_img/bigmak_4.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>10 000р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_4" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="b_r"><strong>Сноуборд</strong><br><img class="ram" src="/_img/bigmak_5.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>15 000р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_5" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="b_r"><strong>Ноутбук</strong><br><img class="ram" src="/_img/bigmak_6.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>30 000р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_6" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="b_r"><strong>ВАЗ 2109</strong><br><img class="ram" src="/_img/bigmak_7.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>220 000р.</b></em></td>
    ...
    <td align="center" class="b"><input type="text" name="mak_2_7" value="0" class="pol_2"></td>
	  ...
	  <tr>
    <td width="160" align="center" class="r"><strong>Роллс Ройс Фантом</strong><br><img class="ram" src="/_img/bigmak_8.jpg" width="75" height="75" hspace="3" vspace="3"><br><em>Цена: <b>17 500 000р.</b></em></td>
