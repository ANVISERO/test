...
$page='';
$page.='
<link href="/_css/1job_profi/1job_profi_print.css" rel="stylesheet" type="text/css">
<div class="profi">
...
$page.="<tr class='X1_".$color."'><td class='X1_left'>".$key."</td><td align='left'>".graf($sal,number_format($sal,1))."</td></tr>";
$color=1-$color;
}
...
$page.="<tr class='X1_".$color."'><td class='X1_left'>".$key."</td><td align='left'>".graf($cash1, number_format($cash1,1))."</td></tr>";
$color=1-$color;
}
$page.='
</table><br>
