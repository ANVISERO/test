...
<p><span class="title_mini">1. Выбор должности &raquo;</span><span class="title_mini_others"> 2. Характеристика компании &raquo;</span><span class="title_mini_others"> 3. Отчет &raquo;</span></p>
...
<!--Должность -->
<tr>
<td width="40%" align="right">Должность</td>
<td height="30">
<div id='jobdiv'>
...
<div id="loading_city" style="display:none">
    ...
    <p align="right"><input type="button" value="дальше &raquo;" class="but1" onClick="return testform1();"></p>
...
{
text="";
if(document.step1.jtype.value==""){text=text+'Должностную группу;\n';}
...
{
text="";
if(document.step1.jtype.value==""){text=text+'Должностная группа;\n';}
if(document.step1.job.value==""){text=text+'Должность;\n';}
if(document.step1.city.value==""){text=text+'Город;\n';}
if(text!=""){window.alert('Вы не выбрали:\n'+text);return false;
} else {
