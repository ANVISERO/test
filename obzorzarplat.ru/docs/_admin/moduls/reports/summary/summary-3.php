...
$q_archive=mysqli_query($link,"INSERT INTO for_users_corporat_reports values('','$user_id','$url','$date','3','null')");
...
include($folder.'_admin/moduls/reports/summary/summary-html.php');
include($folder.'_admin/moduls/reports/summary/summary-excel.php');
include($folder.'_admin/moduls/reports/summary/summary-3-echo.php');
?>