...
if($phone<>''){
echo('<tr>
  <td align="right" width="120">Phone: </td>
<td align="left"><b>'.$phone.'</b></td>
</tr>');}

if($fax<>''){
echo('<tr>
  <td align="right" width="120">Fax: </td>
...
?>
<hr>
<form name="quest" action="/eng/contacts/send/" method="post" onSubmit="return testform();">
<font style=" color:#cc0000; font-size:12px; font-weight:bold">Feedback</font><br>
...
<table width="100%" border="0" cellspacing="0" cellpadding="6">
  ...
  <tr>
    <td width="200" align="right" valign="top">Category of Question:*</td>
...
?>
  ...
  <tr>
    <td width="200" align="right" valign="top">Message:*</td>
    <td align="left" valign="top">
...
?>
    ...
    <td align="left" valign="top">
<strong>*</strong>Enter number: <input name="cap" type="text" class="text" size="3" maxlength="3" style="font-size:20px; font-weight:bold; height:27px">
	</td>
  </tr>
  <tr>
    <td width="200" align="right" valign="top">&nbsp;</td>
    <td align="left" valign="top"><input type="submit" value="Send" class="but"></td>
  </tr>
</table>
</form>
<script>
