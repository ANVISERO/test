...
/*********************************************
  ...
  **********************************************/
  ...
  function getCity(jobId,styleId,user_id) {
		var strURL="/_admin/moduls/reports/lists_ajax/findCity1.php?job="+jobId+"&style="+styleId+"&user_id="+user_id;
		var req = getXMLHTTP();
  ...
  **********************************************/
  ...
  function getSphere(jobId,cityId) {		
		var strURL="/_admin/moduls/findSphere.php?city="+cityId+"&job="+jobId;
		var req = getXMLHTTP();
  ...
  **********************************************/
  ...
  function getStaff(jobId,cityId,sphereId) {		
		var strURL="/_admin/moduls/findStaff.php?city="+cityId+"&job="+jobId+"&sphere="+sphereId;
                var req = getXMLHTTP();
  ...
  **********************************************/
  ...
  function getTurnover(jobId,cityId,sphereId,staffId) {		
		var strURL="/_admin/moduls/findTurnover.php?city="+cityId+"&job="+jobId+"&sphere="+sphereId+"&staff="+staffId;
		var req = getXMLHTTP();
...
/*********************************************
  ...
  **********************************************/
  ...
  function getJob(jtypeId,styleId,userId) {
		var strURL="/_admin/moduls/reports/lists_ajax/findJob.php?jtype="+jtypeId+"&style="+styleId+"&user_id="+userId;
		var req = getXMLHTTP();
