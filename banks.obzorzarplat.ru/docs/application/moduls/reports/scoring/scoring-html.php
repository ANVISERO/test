<?php
$page='
<h1>Отчет о заработной плате '.$job_name_partitive.' '.$region_name_partitive.'</h1>
...
$page1='
<p>Разброс заработных плат составляет: '.number_format($proc_10_salary,0,',',' ').'р. - '.number_format($proc_90_salary,0,',',' ').'р.</p>';
