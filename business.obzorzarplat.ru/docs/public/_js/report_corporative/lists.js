...
/*********************************************
  ...
  **********************************************/
  ...
  function getJobDescript(jobId) {
                var strURL="/application/moduls/reports/lists_ajax/findJobDescript.php?job="+jobId;
		var req = getXMLHTTP();
...
/*********************************************
  ...
  **********************************************/
  ...
  function getCity(jobId,styleId,user_id) {
		var strURL="/application/moduls/reports/lists_ajax/findCity1.php?job="+jobId+"&style="+styleId+"&user_id="+user_id;
		var req = getXMLHTTP();
 ...
 function getBlocksCityJobDescript(jobId,styleId,user_id)
 {
    getJobDescript(jobId);
    getCity(jobId,styleId,user_id);
 }
  ...
  **********************************************/
  ...
  function getSphere(jobId,cityId) {		
		var strURL="/application/moduls/findSphere.php?city="+cityId+"&job="+jobId;
		var req = getXMLHTTP();
  ...
  **********************************************/
  ...
  function getStaff(jobId,cityId,sphereId) {		
		var strURL="/application/moduls/findStaff.php?city="+cityId+"&job="+jobId+"&sphere="+sphereId;
                var req = getXMLHTTP();
  ...
  **********************************************/
  ...
  function getTurnover(jobId,cityId,sphereId,staffId) {		
		var strURL="/application/moduls/findTurnover.php?city="+cityId+"&job="+jobId+"&sphere="+sphereId+"&staff="+staffId;
		var req = getXMLHTTP();
...
/*********************************************
  ...
  **********************************************/
  ...
  function getJob(jtypeId,styleId,userId) {
		var strURL="../application/moduls/reports/lists_ajax/findJob.php?jtype="+jtypeId+"&style="+styleId+"&user_id="+userId;
		var req = getXMLHTTP();
