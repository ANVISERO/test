...
// The actual data
$worksheet->write(0,0,'Таблица 1. Среднемесячные значения должностного оклада (руб. в месяц)',$format3);
...
$n++;
$worksheet->write($n, 0, 'Все данные представлены в российских рублях после выплаты налогов (net)',$format3);
