...
<?php $region_name = (!empty($region_name_partitive)) ? $region_name_partitive : $region_name ?>

<h2>Аналитический обзор заработной платы <?php echo($name_partitive);?> <?= iconv('utf-8','windows-1251//TRANSLIT', "РІ") ?> <?php echo $region_name;?></h2>
...
<p><input type="submit" value="&laquo; Новый отчет" onclick="self.location.href='/work/1job-lite/';" class="submit"></p>
