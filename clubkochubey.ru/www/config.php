...
$config['dbms'] = 'mysql';
$config['db_hostname'] = 'zarplata.mysql';
$config['db_username'] = 'zarplata_mysql';
$config['db_password'] = '70oiwgo9';
$config['db_name'] = 'zarplata_cmsms';
...
#e.g. http://blah.com
$config['root_url'] = 'http://clubkochubey.ru';
...
#$config['root_path'] = '/var/wwwclubkochubey.ru/www';
$config['root_path'] = '/var/www/clubkochubey.ru/www';

#Name of the admin directory
$config['admin_dir'] = 'admin';

#Where do previews get stored temporarily?  It defaults to tmp/cache.
$config['previews_path'] = '/var/www/clubkochubey.ru/www/tmp/cache';

#Where are uploaded files put?  This defaults to uploads.
$config['uploads_path'] = '/var/www/clubkochubey.ru/www/uploads';
...
$config['image_uploads_path'] = '/var/www/clubkochubey.ru/www/uploads/images';
