<?php
		...
		$this->RemovePreference("showwhatpoll");
		$this->RemovePreference("activepoll");
		$this->RemovePreference("showpeekbutton");
		$this->RemovePreference("polltemplate");
		$this->RemovePreference("resulttemplate");
		$this->RemovePreference("polllisttemplate");
