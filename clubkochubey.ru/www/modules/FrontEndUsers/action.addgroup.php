...
if( isset($params['group_id']) )
  {
    ...
    uasort($res,array('RRUtils','compare_elements_by_sortorder_key'));
...
if( isset($params['submit']) )
  {
    $params['input_name'] = serialize($params['input_name']);
    $params['input_required'] = serialize($params['input_required']);
    $params['serialized'] = 1;
