...
if( $this->CheckPermission('Modify Templates') )
  {
    echo $this->SetTabHeader('directorytemplates',
			     $this->Lang('lbl_directorytemplates'));
    ...
    echo $this->SetTabHeader('searchformtemplates',
			     $this->Lang('lbl_searchformtemplates'));
    echo $this->SetTabHeader('browseproptemplates',
			     $this->Lang('lbl_browseproptemplates'));
...
if( $this->CheckPermission('Modify Templates') )
  {
    echo $this->StartTab('directorytemplates');
    include(dirname(__FILE__).'/function.admin_directorytemplates_tab.php');
    echo $this->EndTab();
    ...
    echo $this->StartTab('searchformtemplates');
    include(dirname(__FILE__).'/function.admin_searchformtemplates_tab.php');
    echo $this->EndTab();

    echo $this->StartTab('browseproptemplates');
    include(dirname(__FILE__).'/function.admin_browseproptemplates_tab.php');
    echo $this->EndTab();
