...
$smarty->assign('msg',$this->Lang('info_searchform_templates_tab'));
$smarty->assign('templatelist',
		$this->ShowTemplateList($id,$returnid,'searchform_',
					CGUSERDIR_PREF_NEWSEARCHFORM_TEMPLATE,
					'searchformtemplates',
					CGUSERDIR_PREF_DFLTSEARCHFORM_NAME,
					$this->Lang('addedit_searchform_template'),
					$this->Lang('info_searchform_template')));
