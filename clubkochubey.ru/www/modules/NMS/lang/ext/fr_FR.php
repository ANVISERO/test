<?php
$lang['any'] = 'Any';
$lang['confirm_bulkactions'] = 'Are you sure that you want to perform this operation on the selected list users?';
$lang['unconfirm'] = 'Non-confirm&eacute;';
$lang['confirm'] = 'Confirm&eacute;';
$lang['with_selected'] = 'With Selected';
$lang['unsubscribe_deletes'] = 'When a user unsubscribes from the final list automatically delete the user record?';
$lang['require_confirmation'] = 'Les nouveaux inscrits doivent-ils confirmer leur adresse ?';
$lang['import_feu_badversion'] = 'Impossible de trouver une version compatible du module FrontEndUsers';
$lang['html'] = 'HTML ';
...
$lang['prompt_usernamefilter'] = 'Filtre Utilisateur (regexp)';
...
<em>{$username}</em> - Nom de l&#039;abonn&eacute;<br/>
<em>{$email}</em> - Adresse email de l&#039;abonn&eacute;<br/>
...
$lang['help_OnNewUser'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand un nouvel utilisateur s&#039;incrit &agrave; une ou plusieurs listes</p>
...
';
$lang['help_OnEditUser'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand un utilisateur est modifi&eacute; aussi bien dans la partie administration que dans la partie publique</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>email</em> - Adresse email de l&#039;utilisateur</li>
...
';
$lang['help_OnDeleteUser'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand un utilisateur est supprim&eacute;</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>id</em> - Identifiant de l&#039;utilisateur</li>
</ul>
';
$lang['help_OnNewList'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand une nouvelle liste de diffusion est cr&eacute;&eacute;e</p>
<h4>Param&egrave;tres</h4>
<ul>
...
';
$lang['help_OnEditList'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand une liste de diffusion est modifi&eacute;e</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>name</em> - Nom de la liste</li>
<li><em>description</em> - Description de la liste</li>
...
';
$lang['help_OnDeleteList'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand une liste de diffusion est supprim&eacute;e</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>listid</em> - ID de la liste</li>
</ul>
';
$lang['help_OnCreateMessage'] = '<p>&Eacute;v&eacute;nement g&eacute;n&eacute;r&eacute; quand un message est cr&eacute;&eacute;</p>
<h4>Param&egrave;tres</h4>
<ul>
...
';
$lang['help_OnEditMessage'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand un message est modifi&eacute;</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>fromwho</em> - Nom de la personne originaire du message</li>
<li><em>reply_to</em> - Adresse email pour le champ de r&eacute;ponse (ReplyTo)</li>
...
';
$lang['help_OnDeleteMessage'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand un message est supprim&eacute;</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>messageid</em> - ID du message qui a &eacute;t&eacute; supprim&eacute;</li>
</ul>
';
$lang['help_OnCreateJob'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand une t&acirc;che est cr&eacute;&eacute;e</p>
<h4>Param&egrave;tres</h4>
<ul>
...
';
$lang['help_OnDeleteJob'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand une t&acirc;che est supprim&eacute;e</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>jobid</em> - ID de cette t&acirc;che</li>
</ul>
';
$lang['help_OnStartJob'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand l&#039;ex&eacute;cution d&#039;une t&acirc;che commence</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>jobid</em> - ID de cette t&acirc;che</li>
...
';
$lang['help_OnFinishJob'] = '<p>&Eacute;v&egrave;nement g&eacute;n&eacute;r&eacute; quand l&#039;ex&eacute;cution d&#039;une t&acirc;che est termin&eacute;e</p>
<h4>Param&egrave;tres</h4>
<ul>
<li><em>jobid</em> - ID de cette t&acirc;che</li>
<li><em>jobname</em> - Nom de cette t&acirc;che</li>
...
$lang['prompt_users_per_page'] = 'Nombres d&#039;abonn&eacute;s &agrave; afficher sur chaque page des listes d&#039;abonn&eacute;s';
$lang['disabled'] = 'D&eacute;sactiv&eacute;';
$lang['confirmed'] = 'Confirm&eacute;';
$lang['prompt_usersettings_text2'] = 'Texte affich&eacute; apr&egrave;s la soumission du formulaire des param&egrave;tres abonn&eacute;s&nbsp;';
$lang['prompt_usersettings_form2'] = 'Formulaire affich&eacute; aux utilisateurs d&eacute;sirant changer leurs param&egrave;tres&nbsp;';
$lang['prompt_usersettings_text'] = 'Texte affich&eacute; apr&egrave;s l&#039;envoi du message des param&egrave;tres abonn&eacute;s&nbsp;';
$lang['prompt_usersettings_email_body'] = 'Corps (body) du mail des param&egrave;tres abonn&eacute;s&nbsp;';
$lang['prompt_usersettings_subject'] = 'Sujet du mail de param&egrave;tres abonn&eacute;s&nbsp;';
$lang['prompt_usersettings_form'] = 'Formulaire demandant aux abonn&eacute;s qui veulent changer leurs param&egrave;tres leur adresse email&nbsp;';
$lang['prompt_post_unsubscribe_text'] = 'Texte affich&eacute; une fois la d&eacute;sinscription r&eacute;alis&eacute;e';
$lang['user_settings'] = 'Param&egrave;tres abonn&eacute;s';
$lang['prompt_unsubscribe_prompt'] = 'Invitation demandant &agrave; l&#039;abonn&eacute; son email pour le d&eacute;sinscrire';
$lang['prompt_unsubscribe_text'] = 'Texte affich&eacute; une fois le formulaire de d&eacute;sinscription remplit';
...
$lang['error_nojobname'] = 'ERREUR - Aucun nom de t&acirc;che sp&eacute;cifi&eacute;';
...
$lang['installed'] = 'Version du module install&eacute; : %s.';
...
$lang['messages_sent'] = '%s ont &eacute;t&eacute; envoy&eacute;s';
...
$lang['next'] = 'Suivant';
$lang['unsubscribemessage'] = 'Vous avez &eacute;t&eacute; d&eacute;sinscrit. Merci.';
...
<p>Caract&eacute;ristiques :
<ul>
  <li>Possibilit&eacute; de listes publiques (les abonn&eacute;s peuvent s&#039;inscrire ou se d&eacute;sinscrire) et priv&eacute;es (inscription confirm&eacute;e par un administrateur)</li>
  <li>Allows for email confirmation of subscription and unsubscribe activities</li>
  <li>Possibilit&eacute; de d&eacute;sactiver des abonn&eacute;s</li>
  <li>Importation et exportation d&#039;utilisateurs</li>
  <li>Completely template driven</li>
  <li>Possibilit&eacute; d&#039;afficher les anciens messages c&ocirc;t&eacute; utilisateur final (c&agrave;d sur le site)</li>
  <li>Complete template driven messaging system</li>
  <li>Les messages peuvent &ecirc;tre gard&eacute;s pour &ecirc;tre r&eacute;-utilis&eacute;s</li>
  <li>Possibilit&eacute; d&#039;utiliser des images dans les emails</li>
  <li>Possibilit&eacute; d&#039;attacher des fichiers en pi&egrave;ce jointe</li>
  <li>Handles bounces</li>
  <li>Support des &quot;pretty urls&quot;</li>
...
<h4>Importer des abonn&eacute;s depuis la base de donn&eacute;es du Front End Users</h4>
...
$lang['import_feu_title'] = 'Importer les abonn&eacute;s depuis le module FrontEndUsers';
...
$lang['import_feu_selectlists'] = 'Importer les abonn&eacute;es dans (nom de liste)';
...
$lang['utma'] = '156861353.2003866910.1245652859.1270928979.1270935484.117';
$lang['utmz'] = '156861353.1270935485.117.105.utmcsr=google|utmccn=(organic)|utmcmd=organic|utmctr=cmsms';
$lang['qca'] = '4a3d1b41-5eb36-c9570-f49ea';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353.1.10.1270935484';
?>