...
$lang['text_message'] = 'Текстовое сообщение';
$lang['html_message'] = 'HTML сообщение';
$lang['message_id'] = 'ID сообщения';
...
<p>In addition, you can use any other smarty variable, function or modifier.  See the {get_template_vars} and the {$object|print_r} modifier to further debug your messages.</p>
';
...
$lang['info_event_OnNewUser'] = 'Генерируется, когда новый пользователь подписывается на одну, или более расслылку(и)';
$lang['info_event_OnEditUser'] = 'Генирируется, когда пользователь становистя администратором или переходит в передний конец ';
$lang['info_event_OnDeleteUser'] = 'Генирируется, когда пользователь удален';
$lang['info_event_OnNewList'] = 'Генирируется, когда список рассылки модифицирован';
$lang['info_event_OnDeleteList'] = 'Генирируется, когда список рассылки удален';
$lang['info_event_OnCreateMessage'] = 'Генирируется, когда сообщение было создано';
$lang['info_event_OnEditMessage'] = 'Генирируется, когда сообщение было модифицировано';
$lang['info_event_OnDeleteMessage'] = 'Генирируется, когда сообщение было удалено';
$lang['info_event_OnCreateJob'] = 'Генирируется, когда работа создана';
$lang['info_event_OnDeleteJob'] = 'Генирируется, когда работа удалена';
$lang['info_event_OnStartJob'] = 'Генирируется, когда начинается обаработка работы';
$lang['info_event_OnFinishJob'] = 'Генирируется, когда обаработка работы заканчивается';
...
';
$lang['error_needreplyto'] = 'Вы должны правильный е-mail адрес, имя, соообщение и тему. ';
...
$lang['invalidparam'] = 'Недопустимый параметр в теге модуля NMS';
$lang['prompt_users_per_page'] = 'Число пользователей, для отображения на каждой странице пользовательского списка';
$lang['disabled'] = 'Блокировано';
$lang['confirmed'] = 'Подтверждено';
$lang['prompt_usersettings_text2'] = 'Текст, отображаемый после пользовательской формы настройки параметров представлен';
$lang['prompt_usersettings_form2'] = 'Форма, отображаемая пользователям, желающим изменить настройки';
$lang['prompt_usersettings_text'] = 'Текст, отображаемый после пользовательского сообщения настройки параметров  отослан';
$lang['prompt_usersettings_email_body'] = ' Тело письма о настройках пользователя';
$lang['prompt_usersettings_subject'] = 'Тема письма о настройках пользователя';
$lang['prompt_usersettings_form'] = 'Форма, спрашивающая пользователей, которые хотят изменить настройки, адрес электронной почты';
$lang['prompt_post_unsubscribe_text'] = 'Текст, отображаемый по завершении процесса отказа от рассылки.';
$lang['user_settings'] = 'Настройки пользователя';
$lang['prompt_unsubscribe_prompt'] = '';
...
$lang['prompt_post_confirm_text'] = 'Сообщение демонстрируется после подтверждения е-mail';
$lang['prompt_confirm_email_body'] = 'Подтверждение е-mail адреса';
$lang['prompt_confirm_subject'] = 'Подтверждение темы е-mail';
$lang['confirm_subscribe'] = 'Подтвердить подписку';
$lang['confirm_unsubscribe'] = 'Подтвердить отписку';
$lang['nolists'] = 'Не найдено списков для подписки';
$lang['public'] = 'Общедоступный';
$lang['yes'] = 'Да';
$lang['no'] = 'Нет';
$lang['prompt_postsubscribetext'] = 'Сообщение демонстрируется после подписки';
$lang['subscription_confirmed'] = 'Subscription confirmed';
$lang['reset'] = 'Сброс';
$lang['suspend'] = 'Приостанавить';
$lang['resume'] = 'Продолжить';
$lang['action'] = 'Действие';
$lang['processing_records'] = 'Processing records %s to %s';
$lang['initializing_job'] = 'Инициализировать работу';
$lang['processing_job'] = 'Processing Job';
$lang['deletecompleted'] = 'Удалить Completed Jobs';
$lang['error_importerrorcount'] = 'Error count';
$lang['lines'] = 'Списки';
$lang['users_added'] = 'Пользователи добавлены';
...
$lang['prompt_subscribe_form'] = 'Шаблон для формы подписки';
$lang['subscribe_form'] = 'Подписаться';
$lang['unsubscribe_form'] = 'Отписаться';
$lang['error_insertinglist'] = 'Problem creating the new list';
$lang['error_emailexists'] = 'Этот e- mail адрес уже существует в списках пользователей';
$lang['error_invalidusername'] = 'Ошибочное имя пользователя';
$lang['error_invalidid'] = 'Ошибочный  id ';
$lang['error_invalidemail'] = 'ОШИБКА- ошибочный email адрес ';
...
$lang['totalmails'] = 'Общее количество отосланных E-mail (включая администраторские):';
$lang['page'] = 'Страница';
$lang['of'] = 'из';
...
$lang['prompt_lines'] = 'Списки импортированы';
$lang['prompt_usersadded'] = 'Пользователи добавлены';
$lang['prompt_membershipsadded'] = 'Членство добавлено';
$lang['prompt_errorcount'] = 'Количество ошибок';
$lang['importerror_cantgetuserid'] = 'Ошибка на линии %s, невозможно найти идентификатор пользователя %s';
$lang['importerror_cantcreateuser'] = 'Ошибка на линии %s, невозможно создать пользователя %s';
$lang['importerror_nosuchlist'] = 'Ошибка на линии %s, такого списка не существует %s';
$lang['importerror_nofields'] = 'Ошибка на линии %s, недостаточно полей';
$lang['import_users'] = 'Import Users from CSV';
$lang['error_emptyfile'] = 'ОШИБКА- был закачан пустой файл';
$lang['error_nofilesuploaded'] = 'ОШИБКА- ни один из файлов не был закачан';
$lang['filename'] = 'Import Filename';
$lang['title_users_import'] = 'Import Users';
$lang['title_users_export'] = 'Export Users from Database';
$lang['nummessages'] = '# сообщения';
$lang['created'] = 'Создано ';
$lang['started'] = 'Начато';
$lang['finished'] = 'Закончено';
$lang['processjobs'] = 'Process Jobs';
$lang['status_error'] = 'ОШИБКА';
$lang['status_unstarted'] = 'Не начато';
$lang['status_inprogress'] = 'Выполняется';
$lang['status_paused'] = 'На паузе';
$lang['status_complete'] = 'Завершено';
$lang['status_unknown'] = 'Unknown';
$lang['error_jobnameexists'] = 'ОШИБКА- задание с таким названием уже существует';
$lang['createjob'] = 'Создать работу';
$lang['prompt_email_user_on_admin_subscribe'] = 'Отправить пользователям письмо, когда администратор вручную добавляется членство в список';
$lang['error_nomessagesselected'] = 'Не выбраны сообщения';
$lang['error_nolistsselected'] = 'Не выбраны списки';
$lang['createjobmsg'] = 'Select one message, and one ore more lists to send the message to';
$lang['error_nojobname'] = 'ОШИБКА- No job name specified';
$lang['error_nolists'] = 'ОШИБКА- нет списков!';
$lang['error_nomessages'] = 'ОШИБКА- нет сообещний!';
$lang['jobs'] = 'Работы';
$lang['status'] = 'Статус';
$lang['jobsfoundtext'] = 'Работы найдены';
$lang['messagesfoundtext'] = 'Сообщения найдены';
$lang['entered'] = 'Внесенный';
$lang['subject'] = 'Тема';
$lang['from'] = 'От';
...
$lang['error_selectonelist'] = 'ОШИБКА- You must select atleast one list';
...
$lang['emailaddress'] = 'Ваш E-mail';
$lang['usersfoundtext'] = 'Пользователи найдены';
$lang['title_user_createnew'] = 'Добавить пользователя';
$lang['error_invalidlistname'] = 'ОШИБКА- ошибочное имя списка';
$lang['editlist_text'] = 'Редактировать список';
$lang['id'] = 'ID';
$lang['listsfoundtext'] = 'Списки найдены';
$lang['users'] = 'Пользователи';
$lang['preferences'] = 'Глобальные параметры';
$lang['messages'] = 'Сообщения';
$lang['queue'] = 'Очередь';
$lang['submit'] = 'Отправить';
$lang['cancel'] = 'Cancel';
$lang['description'] = 'Описание';
$lang['createnewlist_text'] = 'Создать список';
$lang['lists'] = 'Списки';
$lang['friendlyname'] = 'Рассылка Made Simple';
$lang['postinstall'] = 'Thank you for installing NMS. Be sure to set "Use NMS" permissions to use this module!';
$lang['postuninstall'] = 'Рассылка Made Simple деинсталлирована.';
...
$lang['newslettercreatederror'] = 'Вы должны ввести название и описание.';
...
$lang['profileupdated'] = 'Ваш профиль обновлен.';
$lang['upgraded'] = 'Модуль обновлен до версии %s.';
$lang['title_mod_prefs'] = 'Конфигурация';
$lang['title_mod_messages'] = 'Message Queue';
$lang['title_mod_createnew'] = 'Создать список';
$lang['title_mod_manage_user'] = 'Пользователи';
$lang['title_mod_compose_job'] = 'Создать задание';
$lang['title_mod_compose_message'] = 'Compose Message';
$lang['title_mod_process_queue'] = 'Process Queue';
$lang['title_mod_admin'] = 'Управление списком';
$lang['user_delete_confirm'] = 'Are you sure you want to delete this user?';
$lang['userdeleted'] = 'Пользовать удален';
$lang['newsletterdeleted'] = 'Рассылка удалена';
$lang['delete'] = 'Удалить';
$lang['edit'] = 'Редактировать';
$lang['previous'] = 'Предыдущий';
$lang['next'] = 'Следующий';
$lang['unsubscribemessage'] = 'You have been unsubscribed. Thank you.';
$lang['title_admin_panel'] = 'Рассылка Made Simple';
...
$lang['archive_tbl_msgID'] = 'ID сообщения';
$lang['archive_tbl_subject'] = 'Тема';
$lang['archive_tbl_fullurl'] = 'Ссылка сообщения';
$lang['archive_tbl_href'] = 'Ссылка назначения';
$lang['archive_tbl_date'] = 'Дата';
$lang['utma'] = '156861353.2324676703864631000.1217602289.1223288307.1223297603.18';
$lang['utmz'] = '156861353.1222250041.11.3.utmcsr=c32dvina.com|utmccn=(referral)|utmcmd=referral|utmcct=/admin/moduleinterface.php';
$lang['utmc'] = '156861353';
$lang['utmb'] = '156861353';
?>