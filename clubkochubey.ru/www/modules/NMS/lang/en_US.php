...
$lang['error_problemwithmessage'] = 'A problem occurred trying to store this message';
...
$lang['info_listfilter'] = '
<strong>Note:</strong> Hold the CTRL key down and click on items to select and deselect them.
';
...
$lang['help_OnNewUser'] = '
<p>An event generated when a new user subscribes to one or more mailing lists</p>
<h4>Parameters</h4>
<ul>
...
<p>An event generated when a user is modified either in the admin or via the front end</p>
<h4>Parameters</h4>
<ul>
<li><em>email</em> - Users email address</li>
<li><em>username</em> - Username</li>
...
';
$lang['help_OnNewList'] = '
<p>An event generated when a new mailing list is created</p>
<h4>Parameters</h4>
<ul>
...
<p>An event generated when a mailing list is modified</p>
<h4>Parameters</h4>
<ul>
<li><em>name</em> - The list name</li>
<li><em>description</em> - List description</li>
...
<p>An event generated when a mailing list is deleted</p>
<h4>Parameters</h4>
<ul>
<li><em>listid</em> - The list ID</li>
</ul>
...
<p>An event generated when a message is created</p>
<h4>Parameters</h4>
<ul>
...
<p>An event generated when a message is modified</p>
<h4>Parameters</h4>
<ul>
<li><em>fromwho</em> - The Name of the person this message is from</li>
<li><em>reply_to</em> - The Email address for the reply to field</li>
...
<p>An event generated when a message is deleted</p>
<h4>Parameters</h4>
<ul>
...
<p>An event generated when a job is created</p>
<h4>Parameters</h4>
<ul>
...
<p>An event generated when a job is deleted</p>
<h4>Parameters</h4>
<ul>
<li><em>jobid</em> - The ID of this job</li>
</ul>
...
<p>An event generated when the processing of a job begins</p>
<h4>Parameters</h4>
<ul>
<li><em>jobid</em> - The ID of this job</li>
<li><em>jobname</em> - The name of this job</li>
...
<p>An event generated when the processing of a job finishes</p>
<h4>Parameters</h4>
<ul>
<li><em>jobid</em> - The ID of this job</li>
<li><em>jobname</em> - The name of this job</li>
...
$lang['error_invalidemail'] = 'Invalid email address';
...
<li><strong>{nms_image name='block name'}</strong>
    ...
    <ul>
    <li><em>prompt='name'</em> : Specify text for the prompt for this field when editing a message that uses this template.
    <li><em>src='image_name'</em> : Specify an image filename.  If this parameter is set there will be no prompt in the message edit form to supply a value for this field.  The file name specified must exist relative to the image uploads path.</li>
...
// this was missing causing an output problem, but I don't know what the actual message should be -- skypanther
$lang['error_problemwithmessage'] = 'Unspecified message problem.'; 

// IMPORT FROM FRONT END USERS LANG VARIABLES
...
// ARCHIVE OF MESSAGES LANG VARIABLES
$lang['archive_heading'] = '<h1>Archive of messages</h1>';
$lang['archivedmessage'] = '<h1>Archived message</h1>';
$lang['archive_tbl_msgID'] = 'Msg ID';
$lang['archive_tbl_subject'] = 'Subject'; // hidden by default in archive.tpl
$lang['archive_tbl_fullurl'] = 'Message link';
$lang['archive_tbl_href'] = 'Link target'; // use this to create your own links, edit archive.tpl, hidden by default
