...
$lang['moddescription'] = 'Een module voor ontwikkelaars om eenvoudig Ajax-functionaliteit in andere modules te gebruiken';
$lang['installed'] = 'Ajax Made Simple versie %s is correct ge&iuml;nstalleerd';
$lang['postinstall'] = 'Ajax Made Simple versie %s is correct ge&iuml;nstalleerd';
$lang['upgraded'] = 'Ajax Made Simple versie is correct opgewaardeerd naar versie %s';
$lang['really_uninstall'] = 'Weet je zeker dat je Ajax Made Simple wil de-installeren? Modules die hiervan afhankelijk zijn, zullen niet meer functioneren!';
$lang['uninstalled'] = 'Ajax Made Simple is met succes ge-deinstalleerd';
$lang['modulenotfound'] = 'Module [%s] is niet gevonden';
$lang['methodnotfound'] = 'Methode [%s] in module [%s] is niet gevonden';
$lang['changelog'] = '<ul>
<li><b>0.1.6</b> -
<li><b>0.1.5</b> - <ul>
...
';
$lang['help'] = '<b>Wat doet het?</b><br/>
Ajax Made Simple is een module voor ontwikkelaars en stelt een API beschikbaar  waarmee module-ontwikkelaars eenvoudig Ajax-functionaliteit aan de frontend van hun module kunnen toevoegen. Beheerfunctionaliteit staat in de planning.
<br/>
<br/>
<b>Hoe gebruikt u het?</b><br/>
Allereerst moet ervoor zorgen dat uw module afhankelijk is van AjaxMadeSimple zodat het op alle systemen werkt. You could add checks to allow functionality without AjaxMadeSimple, but if you want that you probably also
...
';
$lang['utma'] = '156861353.437423124.1198250593.1202212716.1206558273.21';
