...
';
$lang['cal_help'] = '		<h3>&iquest;Qu&eacute; hace esto?</h3>
		<p>El Calendario es un m&oacute;dulo para mostrar eventos en su p&aacute;gina. Cuando el m&oacute;dulo est&aacute; instalado, se agrega una p&aacute;gina de administraci&oacute;n del Calendario en el men&uacute; de plugins, que le permitir&aacute; a usted manejar sus eventos.</p>
		<h3>Seguridad</h3>
		<p>El usuario deber&aacute; pertenecer a un grupo con el permiso de &#039;Modificar el Calendario&#039; con el fin de agregar, editar, o eliminar entradas de eventos en el calendario.</p>
		<h3>&iquest;C&oacute;mo lo puedo usar?</h3>
		<p>El m&oacute;dulo es utilizado en conjunto con la tag cms_module.
		Esto har&aacute; que sea insertado el m&oacute;dulo dentro de la plantilla o p&aacute;gina que usted quiera, y as&iacute; mostrar el calendario.  El c&oacute;digo se va a ver como algo as&iacute;:	<b>{cms_module module=&quot;Calendar&quot;}</b></p>
		<h3>Local</h3>
		<p>El Calendario tambi&eacute;n soporta la traducci&oacute;n de todos los textos incluidos en &eacute;l a otros idiomas. Para soportar su idioma agregue un archivo llamado <b><code><idioma>.php</code></b> al directorio <code>modules/Calendar/lang</code>. Sugiero que como punto de partida copie all&iacute; el archivo en_US.inc.php, luego cambie el nombre al de su idioma y comience a modificarlo.
		Luego usted podr&aacute; seleccionar su idioma en la solapa de Configuraciones ubicada en la administraci&oacute;n del Calendario.</p>
		<p>Tenga en cuenta que usted puede reemplazar el idioma configurado, usando para alg&uacute;n calendario en particular del portal, el siguiente agregado del idioma dentro del tag, tal como se indica a continuaci&oacute;n=&quot;xx_XX&quot; en la llamada {cms_module module=&quot;Calendar&quot;}. Por ejemplo: {cms_module module=&quot;Caldendar&quot; lang=&quot;de_DE&quot;}</p>
		<h3>&iquest;Qu&eacute; Par&aacute;metros se Pueden Usar?</h3>
