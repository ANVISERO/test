...
<?php $this->_cache_serials['/var/www/clubkochubey.ru/www/tmp/templates_c/News^%%3B^3B2^3B2F7B51%%module_db_tpl%3ANews%3Bsummaryrezum.inc'] = '1a501ced8b084020b6c6180b15b66346'; ?><div class="NewsSummary">
...
?>
         <div class="NewsSummaryField">
            <?php if ($this->_tpl_vars['field']->type == 'file'): ?>
                ...
                <?php if ($this->caching && !$this->_cache_including): echo '{nocache:1a501ced8b084020b6c6180b15b66346#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('1a501ced8b084020b6c6180b15b66346','0');echo smarty_cms_function_supersizer(array('path' => ((is_array($_tmp=((is_array($_tmp=$this->_tpl_vars['loc'])) ? $this->_run_mod_handler('cat', true, $_tmp, '/') : smarty_modifier_cat($_tmp, '/')))) ? $this->_run_mod_handler('cat', true, $_tmp, $this->_tpl_vars['theFile']) : smarty_modifier_cat($_tmp, $this->_tpl_vars['theFile'])),'width' => '90'), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:1a501ced8b084020b6c6180b15b66346#0}'; endif;?>
