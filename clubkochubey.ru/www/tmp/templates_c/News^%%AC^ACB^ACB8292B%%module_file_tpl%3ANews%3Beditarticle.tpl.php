...
<?php $this->_cache_serials['/var/www/clubkochubey.ru/www/tmp/templates_c/News^%%AC^ACB^ACB8292B%%module_file_tpl%3ANews%3Beditarticle.tpl.inc'] = '6382305684647970b4f085b9dd9e1635'; ?><?php echo $this->_tpl_vars['startform']; ?>
...
:</p>
		<p class="pageinput"><?php if ($this->caching && !$this->_cache_including): echo '{nocache:6382305684647970b4f085b9dd9e1635#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('6382305684647970b4f085b9dd9e1635','0');echo smarty_function_html_select_date(array('prefix' => $this->_tpl_vars['startdateprefix'],'time' => $this->_tpl_vars['startdate'],'start_year' => "-10",'end_year' => "+15"), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:6382305684647970b4f085b9dd9e1635#0}'; endif;?>
 <?php if ($this->caching && !$this->_cache_including): echo '{nocache:6382305684647970b4f085b9dd9e1635#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('6382305684647970b4f085b9dd9e1635','1');echo smarty_function_html_select_time(array('prefix' => $this->_tpl_vars['startdateprefix'],'time' => $this->_tpl_vars['startdate']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:6382305684647970b4f085b9dd9e1635#1}'; endif;?>
</p>
	</div>
	<div class="pageoverflow">
		<p class="pagetext"><?php echo $this->_tpl_vars['enddatetext']; ?>
:</p>
		<p class="pageinput"><?php if ($this->caching && !$this->_cache_including): echo '{nocache:6382305684647970b4f085b9dd9e1635#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('6382305684647970b4f085b9dd9e1635','2');echo smarty_function_html_select_date(array('prefix' => $this->_tpl_vars['enddateprefix'],'time' => $this->_tpl_vars['enddate'],'start_year' => "-10",'end_year' => "+15"), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:6382305684647970b4f085b9dd9e1635#2}'; endif;?>
 <?php if ($this->caching && !$this->_cache_including): echo '{nocache:6382305684647970b4f085b9dd9e1635#3}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('6382305684647970b4f085b9dd9e1635','3');echo smarty_function_html_select_time(array('prefix' => $this->_tpl_vars['enddateprefix'],'time' => $this->_tpl_vars['enddate']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:6382305684647970b4f085b9dd9e1635#3}'; endif;?>
</p>
	</div>
	</div>
