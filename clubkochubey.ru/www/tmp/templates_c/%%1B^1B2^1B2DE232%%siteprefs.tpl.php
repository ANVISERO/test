<?php /* Smarty version 2.6.25, created on 2014-02-06 13:13:37
...
<?php $this->_cache_serials['/var/www/clubkochubey.ru/www/tmp/templates_c/%%1B^1B2^1B2DE232%%siteprefs.tpl.inc'] = '249fec6d22b46f000df357cfc4c13661'; ?><?php echo $this->_tpl_vars['mod']->StartTabHeaders(); ?>
...
:</p>
	<p class="pageinput">
		...
		<?php if ($this->caching && !$this->_cache_including): echo '{nocache:249fec6d22b46f000df357cfc4c13661#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('249fec6d22b46f000df357cfc4c13661','0');echo smarty_function_html_options(array('options' => $this->_tpl_vars['wysiwyg'],'selected' => $this->_tpl_vars['frontendwysiwyg']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:249fec6d22b46f000df357cfc4c13661#0}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="logintheme">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:249fec6d22b46f000df357cfc4c13661#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('249fec6d22b46f000df357cfc4c13661','1');echo smarty_function_html_options(array('options' => $this->_tpl_vars['themes'],'selected' => $this->_tpl_vars['logintheme']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:249fec6d22b46f000df357cfc4c13661#1}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="custom404template">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:249fec6d22b46f000df357cfc4c13661#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('249fec6d22b46f000df357cfc4c13661','2');echo smarty_function_html_options(array('options' => $this->_tpl_vars['templates'],'selected' => $this->_tpl_vars['custom404template']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:249fec6d22b46f000df357cfc4c13661#2}'; endif;?>
...
:</p>
  <p class="pageinput">
    <select name="basic_attributes[]" multiple="multiple" size="5">
      <?php if ($this->caching && !$this->_cache_including): echo '{nocache:249fec6d22b46f000df357cfc4c13661#3}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('249fec6d22b46f000df357cfc4c13661','3');echo smarty_function_html_options(array('options' => $this->_tpl_vars['all_attributes'],'selected' => $this->_tpl_vars['basic_attributes']), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:249fec6d22b46f000df357cfc4c13661#3}'; endif;?>
