...
$smarty->assign('msg',$this->Lang('info_detail_templates_tab'));
$smarty->assign('templatelist',
		$this->ShowTemplateList($id,$returnid,'detail_',
					CGUSERDIR_PREF_NEWDETAIL_TEMPLATE,
					'detailtemplates',
					CGUSERDIR_PREF_DFLTDETAIL_NAME,
					$this->Lang('addedit_detail_template'),
					$this->Lang('info_detail_template')));
