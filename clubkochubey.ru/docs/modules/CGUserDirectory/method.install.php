...
# Directory Template
$fn = dirname(__FILE__).'/templates/orig_directory_template.tpl';
if( file_exists( $fn ) )
  {
    $template = file_get_contents($fn);
    $this->SetPreference(CGUSERDIR_PREF_NEWDIRECTORY_TEMPLATE,$template);
    $this->SetTemplate('directory_Sample',$template);
    $this->SetPreference(CGUSERDIR_PREF_DFLTDIRECTORY_NAME,'Sample');
  }
...
if( file_exists( $fn ) )
  {
    $template = file_get_contents($fn);
    $this->SetPreference(CGUSERDIR_PREF_NEWSUMMARY_TEMPLATE,$template);
    $this->SetTemplate('summary_Sample',$template);
    $this->SetPreference(CGUSERDIR_PREF_DFLTSUMMARY_NAME,'Sample');
  }
...
if( file_exists( $fn ) )
  {
    $template = file_get_contents($fn);
    $this->SetPreference(CGUSERDIR_PREF_NEWDETAIL_TEMPLATE,$template);
    $this->SetTemplate('detail_Sample',$template);
    $this->SetPreference(CGUSERDIR_PREF_DFLTDETAIL_NAME,'Sample');
  }
