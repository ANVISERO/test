...
$smarty->assign('msg',$this->Lang('info_directory_templates_tab'));
$smarty->assign('templatelist',
		$this->ShowTemplateList($id,$returnid,'directory_',
					CGUSERDIR_PREF_NEWDIRECTORY_TEMPLATE,
					'directorytemplates',
					CGUSERDIR_PREF_DFLTDIRECTORY_NAME,
					$this->Lang('addedit_directory_template'),
					$this->Lang('info_directory_template')));
