...
$smarty->assign('msg',$this->Lang('info_summary_templates_tab'));
$smarty->assign('templatelist',
		$this->ShowTemplateList($id,$returnid,'summary_',
					CGUSERDIR_PREF_NEWSUMMARY_TEMPLATE,
					'summarytemplates',
					CGUSERDIR_PREF_DFLTSUMMARY_NAME,
					$this->Lang('addedit_summary_template'),
					$this->Lang('info_summary_template')));
