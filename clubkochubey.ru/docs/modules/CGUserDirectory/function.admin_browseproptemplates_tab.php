...
$smarty->assign('msg',$this->Lang('info_browseprop_templates_tab'));
$smarty->assign('templatelist',
		$this->ShowTemplateList($id,$returnid,'browseprop_',
					CGUSERDIR_PREF_NEWBROWSEPROP_TEMPLATE,
					'browseproptemplates',
					CGUSERDIR_PREF_DFLTBROWSEPROP_NAME,
					$this->Lang('addedit_browseprop_template'),
					$this->Lang('info_browseprop_template')));
