...
<li>Modulen anv&auml;nds tillsammans med cms_module-taggen. Med den taggen l&auml;gger du till modulen i din mall eller sida, varhelst du vill, och d&aring; visas kalendern. Koden kan se ut s&aring; h&auml;r:
		<tt>{cms_module module=&quot;CGCalendar&quot; table_id=&quot;big&quot;}</tt></p>
...
<h3>Lokalisering</h3>
		...
		<p>Observera att du kan l&aring;ta en viss kalender visa ett annat spr&aring;k p&aring; sidan (frontend) &auml;n vad som st&auml;llts in i Kalenderadministrationen genom att l&auml;gga till lang=&#039;xx_XX&#039; till taggen {cms_module module=&quot;CGCalendar&quot;}. Exempelvis: {cms_module module=&quot;CGCalendar&quot; lang=&quot;sv_SE&quot;}</p>
...
<tr>
	  ...
	  <tr>
		...
		<tr>
			...
			<td>Which template (from the database) to use for list. <em>(optional)</em><p>For example, if you have a template named &quot;blog-post-month-archive-list&quot; then you can call calendar like this:</p><code>{cms_module module=&quot;CGCalendar&quot; display=&quot;list&quot; reverse=&quot;true&quot; dblisttemplate=&quot;blog-post-month-archive-list&quot;}</code></td>
		</tr>
		<tr>
			<td>dbupcominglisttemplate</td>
			<td>Which template (from the database) to use for list of past or upcoming events. <em>(optional)</em><p>For example, if you have a template named &quot;blog-post-list-with-content&quot; and you want to show the latest 50 posts in the &quot;General&quot; category, then you can call calendar like this:</p><code>{cms_module module=&quot;CGCalendar&quot; display=&quot;pastlist&quot; category=&quot;General&quot; dbupcominglisttemplate=&quot;blog-post-list-with-content&quot; limit=&quot;50&quot;}
</code></td>
		</tr>
		</table>
