...
class Questions extends CGExtensions
{
  ...
  function SetParameters()
  {
    ...
    $this->CreateParameter('detailtemplate',$this->Lang('info_admin_selected'),
			   $this->Lang('help_detailtemplate'));
    $this->CreateParameter('formtemplate',$this->Lang('info_admin_selected'),
    ...
    $this->CreateParameter('summarytemplate',$this->Lang('info_admin_selected'),
	...
	if( $dbresult )
	  {
	    ...
	    $result[2] = $this->CreateLink( $articleid, 'default', $returnid,
					    $row['question'],
					    array('mode'=>'detailed',
						  'qid'=>$articleid));
	    return $result;
