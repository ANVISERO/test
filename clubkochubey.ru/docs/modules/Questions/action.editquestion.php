...
if( isset( $params['submit']) )
  {
    ...
    if( $this->CheckPermission(QUESTIONS_PERM) )
      {
	$flds[] = 'category_id'; $parms[] = $category;
	$flds[] = 'author'; $parms[] = $author;
	$flds[] = 'question'; $parms[] = $question;
      }
    if( $this->CheckPermission(QUESTIONS_CANANSWERQUESTIONS) )
      {
	...
	if( $answer != '' )
	  ...
	  {
	    $flds[] = 'answered_by'; $parms[] = NULL; $qmarks[] = "?";
	    $flds[] = 'answered_date'; $parms[] = NULL; $qmarks[] = "?";
	  }
      }
	...
	if( $approved == 'yes' && $answer != '' )
	  ...
	  {
	    $flds[] = 'approved_by'; $parms[] = NULL; $qmarks = "?";
	    $flds[] = 'approved_date'; $parms[] = NULL; $qmarks = "?";
	  }
      }
...
$smarty->assign('startform',$this->CreateFormStart($id,'editquestion',$returnid,
						   'post','',false,'',$params));
