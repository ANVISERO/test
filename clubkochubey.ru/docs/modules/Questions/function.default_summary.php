...
if( $filter != '' )
  {
    ...
    $smarty->assign('input_keywords',
		    $this->CreateInputText($id,'input_keywords',
    ...
    $smarty->assign('input_answered_by',
		    $this->CreateInputText($id,'input_answered_by',
...
$smarty->assign_by_ref('items',$entries);
