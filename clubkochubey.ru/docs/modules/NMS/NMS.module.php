...
#require_once(dirname(__FILE__)."/checkdns_windows.php");
...
';
  ...
  function SetParameters()
  {
    ...
    $this->SetParameterType('msg_permalink',CLEAN_STRING);
  ...
  /*---------------------------------------------------------
   ...
   ---------------------------------------------------------*/
  function _ProcessOneEmail($id,&$message,$destrow,$job_id = -1)
  {
    global $gCms;
    $smarty =& $gCms->GetSmarty();
    ...
    //
    $mailer->AddAddress($destrow['email']);
    $mailer->Send();    	
  }
