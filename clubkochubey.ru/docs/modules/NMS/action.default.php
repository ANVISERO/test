...
#-------------------------------------------------------------------------
#END_LICENSE
$hogan = "onfocus=\"if(this.value=='Ваш e-mail') {this.value=''}\" onblur=\"if(this.value=='') this.value=this.defaultValue;\" class=\"subsc\"";
 ...
 case 'unsubscribe':
   {
     ...
     $smarty->assign('email', $this->CreateInputText($id, 'email','',
							   34, 150 ));
     $smarty->assign('formend',$this->CreateFormEnd());
     $smarty->assign('email', $this->CreateInputText($id, 'email','',60, 150 ));
