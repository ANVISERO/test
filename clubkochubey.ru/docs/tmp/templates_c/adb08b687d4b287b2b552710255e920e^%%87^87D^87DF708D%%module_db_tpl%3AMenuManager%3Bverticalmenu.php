<?php /* Smarty version 2.6.25, created on 2012-06-10 14:59:13
         compiled from module_db_tpl:MenuManager%3Bverticalmenu */ ?>
<?php require_once(SMARTY_CORE_DIR . 'core.load_plugins.php');
smarty_core_load_plugins(array('plugins' => array(array('function', 'repeat', 'module_db_tpl:MenuManager;verticalmenu', 25, false),array('modifier', 'cat', 'module_db_tpl:MenuManager;verticalmenu', 45, false),)), $this); ?>
<?php $this->_cache_serials['/home/zarplata/clubkochubey.ru/docs/tmp/templates_c/adb08b687d4b287b2b552710255e920e^%%87^87D^87DF708D%%module_db_tpl%3AMenuManager%3Bverticalmenu.inc'] = '8b65a8331db8701c606058851eaedc6f'; ?><?php echo '
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8b65a8331db8701c606058851eaedc6f#0}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8b65a8331db8701c606058851eaedc6f','0');echo smarty_cms_function_repeat(array('string' => '<ul class="unli">','times' => $this->_tpl_vars['node']->depth-$this->_tpl_vars['node']->prevdepth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8b65a8331db8701c606058851eaedc6f#0}'; endif;?>

<?php elseif ($this->_tpl_vars['node']->depth < $this->_tpl_vars['node']->prevdepth): ?>
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8b65a8331db8701c606058851eaedc6f#1}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8b65a8331db8701c606058851eaedc6f','1');echo smarty_cms_function_repeat(array('string' => '</li></ul>','times' => $this->_tpl_vars['node']->prevdepth-$this->_tpl_vars['node']->depth), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8b65a8331db8701c606058851eaedc6f#1}'; endif;?>
...
<?php if ($this->caching && !$this->_cache_including): echo '{nocache:8b65a8331db8701c606058851eaedc6f#2}'; endif;$_cache_attrs =& $this->_smarty_cache_attrs('8b65a8331db8701c606058851eaedc6f','2');echo smarty_cms_function_repeat(array('string' => '</li></ul>','times' => $this->_tpl_vars['node']->depth-1), $this);if ($this->caching && !$this->_cache_including): echo '{/nocache:8b65a8331db8701c606058851eaedc6f#2}'; endif;?>
